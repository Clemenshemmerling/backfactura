...
var _CertificateTemplate = require("./CertificateTemplate.js");

var _CertificateTemplate2 = _interopRequireDefault(_CertificateTemplate);

var _CAVersion = require("./CAVersion.js");

var _CAVersion2 = _interopRequireDefault(_CAVersion);
	...
	fromSchema(schema) {
		...
		switch (this.extnID) {
			...
			case "1.3.6.1.4.1.311.21.7":
				...
				try {
					this.parsedValue = new _CertificateTemplate2.default({ schema: asn1.result });
				} catch (ex) {
					this.parsedValue = new _CertificateTemplate2.default();
			...
			case "1.3.6.1.4.1.311.21.1":
				...
				try {
					this.parsedValue = new _CAVersion2.default({ schema: asn1.result });
				} catch (ex) {
					this.parsedValue = new _CAVersion2.default();
