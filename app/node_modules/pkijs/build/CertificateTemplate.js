...
class CertificateTemplate {
  ...
  */
   ...
   */
		...
		return new asn1js.Sequence({
			...
			value: [new asn1js.ObjectIdentifier({ name: names.templateID || "" }), new asn1js.Integer({
  ...
  */
	fromSchema(schema) {
		...
		(0, _pvutils.clearProps)(schema, ["templateID", "templateMajorVersion", "templateMinorVersion"]);
		//endregion
  ...
  */
	toSchema() {
		...
		if ("templateMajorVersion" in this) outputArray.push(new asn1js.Integer({ value: this.templateMajorVersion }));

		if ("templateMinorVersion" in this) outputArray.push(new asn1js.Integer({ value: this.templateMinorVersion }));
		//endregion
